...
void as::CodeGenerator::compile(std::shared_ptr<tac::BasicBlock> block, StatementCompiler& compiler){
    compiler.reset();
...
void as::CodeGenerator::compile(std::shared_ptr<tac::Function> function){
...
//TODO Certainly dispatch some of the assembly into the implementations
