...
VariableOperation::VariableOperation(std::shared_ptr<Context> context, const Tok token, const std::string& variable, std::shared_ptr<Value> v) : ParseNode(context, token), m_variable(variable), value(v) {}
