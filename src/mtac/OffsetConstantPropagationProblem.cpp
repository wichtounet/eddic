...
bool mtac::OffsetConstantPropagationProblem::optimize(std::shared_ptr<mtac::Quadruple>& quadruple, std::shared_ptr<mtac::DataFlowResults<ProblemDomain>> global_results){
